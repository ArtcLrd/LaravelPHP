...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\wamp64\www\testProject\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\wamp64\\www\\testProject\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'login','logout','register','password.request','password.email','password.reset','password.update',
'password.confirm','home','posts.index','posts.create',
'posts.store','posts.show','posts.edit','posts.update','posts.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','home','inc.messages','layouts.app','pages.about',
'pages.index','pages.services','posts.create','posts.edit','posts.index',
'posts.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
